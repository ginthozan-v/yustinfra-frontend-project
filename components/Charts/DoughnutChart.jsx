...
function DoughnutChart({ data, width, height, currentTotal, total }) {
  ...
  return (
    <div className="flex flex-col justify-center grow">
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 grid w-full h-full text-center place-content-center">
          <h1 className="text-4xl font-bold text-indigo-400">
            {calculatePercentage(currentTotal, total)}%
          </h1>
          <h4>
            {currentTotal}/{total}
          </h4>
